...
The documentation tree comprises **612 markdown files** across four
layers:
...
| Per-file deep dives | 508 | `file-<basename>.md` alongside each source file (some consolidated per family) |
