...
The documentation tree comprises **628 markdown files** across four
layers:
...
| Per-file deep dives | 509 | `file-<basename>.md` alongside each source file (some consolidated per family) |
