...
The documentation tree comprises **597 markdown files** across four
layers:
...
| Per-file deep dives | 493 | `file-<basename>.md` alongside each source file (some consolidated per family) |
