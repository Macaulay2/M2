...
// I could imagine there is a faster way to do this, but currently the only place
// this code is used is with NTL LLL, and even then, only to transfer elements to/from ntl integers
