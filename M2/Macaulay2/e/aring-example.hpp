...
class ARingExample : public RingInterface
{
 ...
 public:
  ...
  // Hash values are used in the front end of M2 to implement keys for hash
  // tables.
  ...
  */
  ...
  // In gmp, it is not set to 0, but here, we make sure it is initialized to a 0
  // value.
  ...
  bool set_var(ElementType& result, int v) const
  {
