...
varpower_word res_varpower_monomials::simple_degree(const_varpower_monomial m)
{
  varpower_word i;
  varpower_word sum = 0;
...
varpower_word res_varpower_monomials::weight(const_varpower_monomial m, M2_arrayint wts)
{
  varpower_word i;
  varpower_word sum = 0;
  varpower_word npairs = *m;
...
int res_varpower_monomials::equal(const_varpower_monomial m1,
...
int res_varpower_monomials::compare(const_varpower_monomial a, const_varpower_monomial b)
...
void res_varpower_monomials::lcm(const_varpower_monomial m1,
                             const_varpower_monomial m2,
...
void res_varpower_monomials::mult(const_varpower_monomial m1,
                              const_varpower_monomial m2,
                              varpower_monomial result)
{
  /* result: should be a pointer to a spot with enough space for the result */
...
void res_varpower_monomials::quotient(const_varpower_monomial m1,
                                  const_varpower_monomial m2,
                                  varpower_monomial result)
{
  /* result: should be a pointer to a spot with enough space for the result */
...
int res_varpower_monomials::divides(const_varpower_monomial m1,
                                const_varpower_monomial m2,
                                varpower_monomial result)
{
...
void res_varpower_monomials::elem_text_out(FILE *fil, const_varpower_monomial m)
{
  varpower_word v,e;
  varpower_word n = *m++;
