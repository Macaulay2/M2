...
namespace safe {
     ...
     static inline int32_t fits_7(int32_t x,const char *msg) {
       if expect_false (((uint32_t)x & ~0x7f) != 0) ov(msg);
          return x;
     }
     static inline int32_t fits_15(int32_t x,const char *msg) {
          if expect_false (((uint32_t)x & ~0x7fff) != 0) ov(msg);
          return x;
     }
     ...
     static inline int32_t fits_7(int32_t x) { return fits_7(x,"monomial exponent overflow: fits_7"); }
     static inline int32_t fits_15(int32_t x) { return fits_15(x,"monomial exponent overflow: fits_15"); }
     static inline int32_t fits_31(int32_t x) { return fits_31(x,"monomial exponent overflow: fits_31"); }

     static inline int32_t over_1(int32_t x) { return x < 0 ; }
     static inline int32_t over_2(int32_t x) { return (0x80008000u & (uint32_t)x) != 0 ; }
     static inline int32_t over_4(int32_t x) { return (0x80808080u & (uint32_t)x) != 0 ; }

     static inline int32_t add(int32_t x, int32_t y, const char *msg) {
          int32_t z = (uint32_t)x+(uint32_t)y;
          if expect_false ((int32_t)((uint32_t)x^(uint32_t)z) < 0 && (int32_t)((uint32_t)x^(uint32_t)y) >= 0) ov(msg);
          return z;
     }
     ...
     static inline int32_t pos_add_2(int32_t x, int32_t y) {
          return pos_add_2(x,y,"monomial exponent overflow: pos int32_t + pos int32_t, packed 2");
     }
     ...
     static inline int32_t pos_add_4(int32_t x, int32_t y) {
          return pos_add_4(x,y,"monomial exponent overflow: pos int32_t + pos int32_t, packed 4");
     }
     ...
     static inline int32_t mult_by(int32_t &x, int32_t y) {
          return mult_by(x,y,"monomial exponent overflow: int32_t * int32_t (mult_by)");
     }

     static inline int32_t div(int32_t x, int32_t y, const char *msg) {
          if expect_false ((uint32_t)x == -(uint32_t)x && x < 0 && y == -1) ov(msg);
          return x / y;
     }
