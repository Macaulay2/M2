...
void MarkedGB::marked_remainder(POLY &f, bool use_denom, ring_elem &denom, gbvector *marked_lead_term)
  // If marked_lead_term is not NULL, then it should be a pointer
  // to a term in f.f.  This term will not be reduced, and the new lead term will replace this one.
