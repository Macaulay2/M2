...
*/
  ...
  template<>
  inline bool ConcreteRing<ARingGFFlint>::promote(const Ring *Rf, const ring_elem f, ring_elem &result) const
  {
    ElementType a;
    ring().init(a);
    bool retval = ring().promote(Rf,f,a);
  ...
  template<>
  inline bool ConcreteRing<ARingGFFlint>::lift(const Ring *Rg, const ring_elem f, ring_elem &result) const
  {
    ElementType a;
    ring().init(a);
    ring().from_ring_elem(a, f);
