...
// The following are all the routines required by 'ring'
  ...
  void to_ring_elem(ring_elem &result, const ElementType &a);
  void from_ring_elem(ElementType &result, const ring_elem &a); // result should have been 'init'ed
...
public:
  ...
  // (This happens over ZZ if f is non-zero (therefore 1 or -1, over a finite filed if f != 0,
