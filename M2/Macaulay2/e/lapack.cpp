  ...
  if (precision > 53)
    {
      ...
      mpfr_set_default_prec(
          precision);  // has no effect on default_precision in mpack!!!
      ...
      __mpfr_struct *cursor;  // i  is column of mpack matrix, j is row of mpack
                              // matrix, k is column of mpfr matrix, l is row of
                              // mpfr matrix
