...
M2_Complex * make_M2_Complex(double re, double im)
{
  M2_Complex *c = (M2_Complex *) getmem_atomic(sizeof(double)*2);
  c->re = re;
  c->im = im;
  return c;
}
...
{
  LMatrixCC *M;
  M2_Complex *z = (M2_Complex *) getmem_atomic(sizeof(double)*2);
  int i, rows;
...
int main(int argc, char **argv)
{
  ...
  LP_LMatrixCC_set_entry(M,0,1, make_M2_Complex(1,0));
  LP_LMatrixCC_set_entry(M,1,2, make_M2_Complex(1,0));
  LP_LMatrixCC_set_entry(M,2,3, make_M2_Complex(1,0));
  LP_LMatrixCC_set_entry(M,0,0, make_M2_Complex(-1,-0.5));
  LP_LMatrixCC_set_entry(M,1,1, make_M2_Complex(-1,-0.5));
  LP_LMatrixCC_set_entry(M,2,2, make_M2_Complex(-1,-0.5));
  LP_LMatrixCC_set_entry(M,3,3, make_M2_Complex(-1,-0.5));
  ...
  LP_LMatrixCC_set_entry(M,0,0, make_M2_Complex(3,2.2));
  LP_LMatrixCC_set_entry(M,0,1, make_M2_Complex(-1.2,-4.2));
  LP_LMatrixCC_set_entry(M,0,2, make_M2_Complex(30,0.2));
  LP_LMatrixCC_set_entry(M,0,3, make_M2_Complex(0,2.0));
  LP_LMatrixCC_set_entry(M,1,0, make_M2_Complex(5.3,2.1));
  LP_LMatrixCC_set_entry(M,1,1, make_M2_Complex(3.9,8.2));
  LP_LMatrixCC_set_entry(M,1,2, make_M2_Complex(3,20.2));
  LP_LMatrixCC_set_entry(M,1,3, make_M2_Complex(32,-12.2));
  LP_LMatrixCC_set_entry(M,2,0, make_M2_Complex(3,2.2));
  LP_LMatrixCC_set_entry(M,2,1, make_M2_Complex(3.33,7.5));
  LP_LMatrixCC_set_entry(M,2,2, make_M2_Complex(1.23,2.2));
  LP_LMatrixCC_set_entry(M,2,3, make_M2_Complex(2.32,8.12));
  LP_LMatrixCC_set_entry(M,3,0, make_M2_Complex(5.3,-1.2));
  LP_LMatrixCC_set_entry(M,3,1, make_M2_Complex(0.3,2.8));
  LP_LMatrixCC_set_entry(M,3,2, make_M2_Complex(3,2.0));
  LP_LMatrixCC_set_entry(M,3,3, make_M2_Complex(-0.3,2.8));
  ...
  LP_LMatrixCC_set_entry(M,0,0, make_M2_Complex(3,0));
  LP_LMatrixCC_set_entry(M,0,1, make_M2_Complex(-1.2,-4.2));
  LP_LMatrixCC_set_entry(M,0,2, make_M2_Complex(30,0.2));
  LP_LMatrixCC_set_entry(M,0,3, make_M2_Complex(0,2.0));
  LP_LMatrixCC_set_entry(M,1,0, make_M2_Complex(-1.2,4.2));
  LP_LMatrixCC_set_entry(M,1,1, make_M2_Complex(3.9,0));
  LP_LMatrixCC_set_entry(M,1,2, make_M2_Complex(3,20.2));
  LP_LMatrixCC_set_entry(M,1,3, make_M2_Complex(32,-12.2));
  LP_LMatrixCC_set_entry(M,2,0, make_M2_Complex(30,-0.2));
  LP_LMatrixCC_set_entry(M,2,1, make_M2_Complex(3,-20.2));
  LP_LMatrixCC_set_entry(M,2,2, make_M2_Complex(1.23,0));
  LP_LMatrixCC_set_entry(M,2,3, make_M2_Complex(2.32,8.12));
  LP_LMatrixCC_set_entry(M,3,0, make_M2_Complex(0,-2.0));
  LP_LMatrixCC_set_entry(M,3,1, make_M2_Complex(32,12.2));
  LP_LMatrixCC_set_entry(M,3,2, make_M2_Complex(2.32,-8.12));
  LP_LMatrixCC_set_entry(M,3,3, make_M2_Complex(-0.3,0));
  ...
  LP_LMatrixCC_set_entry(target,0,0, make_M2_Complex(1,0));
  LP_LMatrixCC_set_entry(target,1,0, make_M2_Complex(1,0));
  LP_LMatrixCC_set_entry(target,2,0, make_M2_Complex(1,0));
  LP_LMatrixCC_set_entry(target,3,0, make_M2_Complex(1,0));
  LP_LMatrixCC_set_entry(target,0,1, make_M2_Complex(-1,-0.5));
  LP_LMatrixCC_set_entry(target,1,1, make_M2_Complex(1,0.5));
  LP_LMatrixCC_set_entry(target,2,1, make_M2_Complex(-1,-0.5));
  LP_LMatrixCC_set_entry(target,3,1, make_M2_Complex(-2,3.5));
  ...
  assert(LP_LMatrixCC_is_close(LP_LMatrixCC_mult(M, solutions),
			       target, tolerance));
  ...
  assert(LP_LMatrixCC_is_close(LP_LMatrixRC_add(N,C1),
  ...
  assert(LP_LMatrixCC_is_close(LP_LMatrixCC_add(C1,C2),
  ...
  assert(LP_LMatrixCC_is_close(LP_LMatrixCC_mult(LP_LMatrixCR_mult(C2,
  ...
  assert(LP_LMatrixRR_is_close(targ, LP_LMatrixRR_mult(N, sols), tolerance));
  /* assert(LP_LMatrixRR_is_equal(targ, LP_LMatrixRR_mult(N, sols))); */
  ...
  assert(LP_LMatrixRR_is_close(LP_LMatrixRR_mult(R3, LP_LMatrixRR_mult(R1,R2)),
			       N, tolerance));
  ...
  assert(LP_LMatrixRR_is_close(N,
  ...
  assert(LP_LMatrixRR_is_close(LP_LMatrixRR_mult(N,eigvecs),
  ...
  LP_LMatrixCC_set_entry(M,0,2, make_M2_Complex(30,0.2));
  LP_LMatrixCC_set_entry(M,0,3, make_M2_Complex(0,2.0));
  LP_LMatrixCC_set_entry(M,0,4, make_M2_Complex(0.3,2.8));
  LP_LMatrixCC_set_entry(M,1,0, make_M2_Complex(5.3,2.1));
  LP_LMatrixCC_set_entry(M,1,1, make_M2_Complex(3.9,8.2));
  LP_LMatrixCC_set_entry(M,1,2, make_M2_Complex(3,20.2));
  LP_LMatrixCC_set_entry(M,1,3, make_M2_Complex(32,12.2));
  LP_LMatrixCC_set_entry(M,1,4, make_M2_Complex(3,2.0));
  LP_LMatrixCC_set_entry(M,2,0, make_M2_Complex(3,2.2));
  LP_LMatrixCC_set_entry(M,2,1, make_M2_Complex(3.33,7.5));
  LP_LMatrixCC_set_entry(M,2,2, make_M2_Complex(1.23,2.2));
  LP_LMatrixCC_set_entry(M,2,3, make_M2_Complex(2.32,8.12));
  LP_LMatrixCC_set_entry(M,2,4, make_M2_Complex(5.3,1.2));
