#ifndef __memory_block_2_hpp__
#define __memory_block_2_hpp__
...
{
public:
  MemoryBlock2() { mArena = new memt::Arena; }
  ~MemoryBlock2() { delete mArena; }
  //MemoryBlock2(MemoryBlock2&& source) : mArena(std::move(source.mArena)) {}

  //MemoryBlock2& operator=(MemoryBlock2&& source) {
