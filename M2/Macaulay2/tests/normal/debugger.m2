...
assert( (disassemble'({"A" => 123} >> o -> x -> (x, o))) === "(1-OP guard (adjacent (global-fetch [...]) (sequence (local-fetch 1 1) (adjacent (global-fetch [...]) (sequence (local-fetch 0 1) (local-fetch 0 0))))))" );
assert( (disassemble'(true >> o -> x -> (x, o))) === "(1-OP guard (adjacent (global-fetch [...]) (sequence (local-fetch 1 1) (adjacent (global-fetch [...]) (sequence (null) (local-fetch 0 0))))))" );
f = x -> y -> x = x+y;
