...
C = res(I, LengthLimit => 4)						    -- used to crash (without LengthLimit given too).
-- scan(0 .. 4,  { 1, 6, 11, 19, 20 }, (i,r) -> assert( numgens C_i == r ))
-- with resolution code introduced in version M2 1.26.05, the Betti numbers come out bit nicer:
