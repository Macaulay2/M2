...
assert( (toString Complex) === "Complex" )
assert( (toString ComplexMap) === "ComplexMap" )
...
assert( (toString Dynamic) === "Dynamic" )
assert( (toString E) === "E" )
...
assert( (toString GradedModule) === "Complex" )
assert( (toString GradedModuleMap) === "ComplexMap" )
...
assert( (toString res) === "freeResolution" )
assert( (toString reshape) === "reshape" )
assert( (toString resolution) === "freeResolution" )
