...
use Q
S = Q/(I+ideal{b^3})
res(coker vars S, LengthLimit => 6)
...
S = R/K
-- gbTrace = 3
C = res(coker vars S, LengthLimit => 5)  -- goes to higher and higher degree without stopping: FIXED: 6/20/06

-- Not sure how to check this:
-- netList {net betti C}, netList{ net"       0 1  2  3   4   5
-- total: 1 4 13 41 129 406
--     0: 1 4  6  4   1   .
--     1: . .  3 12  18  12
--     2: . .  4 22  58  93
--     3: . .  .  3  36 150
