...
assert ( binomial(5, 3.0) === 10 )
assert ( binomial(5, 3/1) === 10 )
assert ( binomial(5, interval(3, 3)) === 10 )
assert ( binomial(5, 3 + 0 * ii) === 10 )
assert ( binomial(5.0, 3) === 10 )
assert ( binomial(5.0, 3.0) === 10 )
assert ( binomial(5.0, 3/1) === 10 )
assert ( binomial(5.0, interval(3, 3)) === 10 )
assert ( binomial(5.0, 3 + 0 * ii) === 10 )
assert ( binomial(5/1, 3) === 10 )
assert ( binomial(5/1, 3.0) === 10 )
assert ( binomial(5/1, 3/1) === 10 )
assert ( binomial(5/1, interval(3, 3)) === 10 )
assert ( binomial(5/1, 3 + 0 * ii) === 10 )
assert ( binomial(interval(5, 5), 3) === 10 )
assert ( binomial(interval(5, 5), 3.0) === 10 )
assert ( binomial(interval(5, 5), 3/1) === 10 )
assert ( binomial(interval(5, 5), interval(3, 3)) === 10 )
assert ( binomial(interval(5, 5), 3 + 0 * ii) === 10 )
assert ( binomial(5 + 0 * ii, 3) === 10 )
assert ( binomial(5 + 0 * ii, 3.0) === 10 )
assert ( binomial(5 + 0 * ii, 3/1) === 10 )
assert ( binomial(5 + 0 * ii, interval(3, 3)) === 10 )
assert ( binomial(5 + 0 * ii, 3 + 0 * ii) === 10 )
