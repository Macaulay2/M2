...
namespace mixedCells
{
  ...
  public:
    ...
    friend MyInt operator-(MyInt const &a)
    {
      return MyInt(-a.rep);
    }
    friend MyInt operator-(MyInt const &a, MyInt const &b)
    ...
    //    friend class MyGen operator/(MyInt const &a, MyGen const &b);//!!!!!!!!!!
    friend int volumeToInt(MyInt const &a)
    {
      return volumeToInt(a.rep);
    }
    friend MyInt operator*(MyInt const &s, MyInt const &t)
    {
    ...
    friend double toDoubleForPrinting(MyInt const &s)//change this to produce string
    {
      return s.rep;
    }
    friend std::ostream& operator<<(std::ostream& s, const MyInt &a)
    {
      s<<toDoubleForPrinting(a);
      return s;
    }
    /*    friend bool isGreaterEqual(MyInt const &a, MyInt const &b)
    {
      return greaterEqual(a,b);
      }*/
    friend bool isNegative(MyInt const &a)
    {
      return a.rep<-EPSILON;
    }
    friend bool isEpsilonLessThan(MyInt const &a, MyInt const &b)
    {
  ...
  public:
    ...
    friend bool isZero2(TrueInt const &a)
    {
      return (a.rep==0);
    }
    ...
    //    friend class TrueGen operator/(TrueInt const &a, TrueGen const &b);//!!!!!!!!!!
    friend int volumeToInt(TrueInt const &a)
    {
      return a.rep;
    }
    friend TrueInt operator*(TrueInt const &s, TrueInt const &t)
    {
      return TrueInt(s.rep*t.rep);
    }
    ...
    friend std::ostream& operator<<(std::ostream& s, const TrueInt &a)
    {
      s<<a.rep;
      return s;
    }
    /*    friend bool isGreaterEqual(TrueInt const &a, TrueInt const &b)
    {
      return greaterEqual(a,b);
      }*/
    friend bool isNegative(TrueInt const &a)
    {
      return a.rep<0;
    }
    friend bool isEpsilonLessThan(TrueInt const &a, TrueInt const &b)
    {
      return a.rep<b.rep;
    }
  };
  ...
  public:
    ...
    friend bool isZero(MyGen const &a)
    {
      return isZero(a.rep);
    }
    friend bool isZero2(MyGen const &a)
    {
      return isZero(a.rep);
    }
    ...
    friend MyGen operator-(MyGen const &a)
    {
      return MyGen(-a.rep);
    }
    friend MyGen operator-(MyGen const &a, MyGen const &b)
    ...
    friend MyGen operator*(MyGen const &s, MyGen const &t)
    {
      //      assert(0);//WHY IS THIS CALLED?
      return MyGen(s.rep*t.rep);
    }
    /*    friend class MyGen operator/(MyInt const &a, MyGen const &b)
    {
      return MyGen(a.rep/b.rep);
      }*/
    void operator+=(MyGen const &a)
    {
      rep+=a.rep;
    }
    void operator-=(MyGen const &a)
    ...
    friend bool isNegative(MyGen const &a)
    {
      return a.rep<-EPSILON;
    }
    friend double toDoubleForPrinting(MyGen const &s)//change this to produce string
    {
      return s.rep;
    }
    friend std::ostream& operator<<(std::ostream& s, const MyGen &a)
    {
      s<<toDoubleForPrinting(a);
      return s;
    }
    friend bool isGreaterEqual(MyGen const &a, MyGen const &b)
    {
      return isGreaterEqual(a.rep,b.rep);
    }
    friend bool operator<(MyGen const &a, MyGen const &b)
    {
      return a.rep<b.rep;
    }
  };
