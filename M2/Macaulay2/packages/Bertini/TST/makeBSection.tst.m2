...
assert(class s===BertiniHyperplane)
assert(#keys s==2)
...
assert(class sReal#BNumberCoefficients_0===RR)
...
assert(class sRational#BNumberCoefficients_0===QQ)
...
assert(class sInteger#BNumberCoefficients_0===ZZ)
...
P={1,2,3}
options bHyperplane
affineContainingPoint=bHyperplane({x,y,z},ContainsPoint=>P, BNumberCoefficients=>{2,5,7})
r= affineContainingPoint#BHyperplaneString
...
rHomogeSection= bHyperplane(
    {x,y,z},ContainsPoint=>P,BHomogenization=>"x+y+z",BNumberCoefficients=>{2,5,7})
peek rHomogeSection
assert(rHomogeSection#BHyperplaneString=="(2)*(x-(x+y+z)*(1))+(5)*(y-(x+y+z)*(2))+(7)*(z-(x+y+z)*(3))")
-----
f="y^3-x*y+1"
s1=makeB'Section({x,y,1},BNumberCoefficients=>{1.47364+1.1251*ii, .869195+.661049*ii, .115018-.813524*ii})
...
l=makeB'Section({x,y,z},NameB'Section=>"l",BNumberCoefficients=>{.566814+1.5942*ii, -.524471+.609431*ii, .364689+.0869259*ii})
f="S^3+x^3+y^3+z^3-l^3"
s1=makeB'Section({x,y,1},BNumberCoefficients=>{1.47364+1.1251*ii, .869195+.661049*ii, .115018-.813524*ii})
s2=makeB'Section({x,y,1},BNumberCoefficients=>{ -.607416+.747061*ii, .939866-.205217*ii, -.814605-.233723*ii})
makeB'InputFile(storeBM2Files,
