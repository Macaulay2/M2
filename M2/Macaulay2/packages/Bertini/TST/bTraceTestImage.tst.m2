needsPackage "Bertini"
     ...
     R=CC[x0,x1,x2]
     F={x0^3-x1^3+x2^3+1}
     sliceH=makeB'Slice({0,0},{x0,x1,x2,1},NameB'Slice=>"H",B'NumberCoefficients => {{1.31226+1.5445*ii, -.365044+1.05073*ii, 1.05898+1.0507*ii, -.348229+.168593*ii}, {.899764+.780578*ii, -.676936-.130762*ii, -.0064778-.407225*ii, .531146-.569493*ii}}                                      )
...
--   Example    
     ...
     sliceH=makeB'Slice({0,0},{x,y,z,1},NameB'Slice=>"H",B'NumberCoefficients => {{-.340395+.508813*ii, 1.50753+.649406*ii, .660055-.674066*ii, .191868-.0701391*ii}, {.630048+.052575*ii, .176085+.684432*ii, .438564+.0946367*ii, .569508+.010619*ii}})
     makeB'InputFile(storeBM2Files,
