...
doc ///
   ...
   Usage
    ...
    FourierInverse A
   Inputs
     A:{Matrix, RingElement, LeftIdeal, ChainComplex}
       over the Weyl algebra
   Outputs
     :{Matrix, RingElement, LeftIdeal, ChainComplex}
