doc ///
  ...
  References
      [BK86] Barlet, Kashiwara, Le r\'{e}seau $L^2$ d'un syst\`{e}me holonome r\'{e}gulier,
      Invent. Math. 86(1):35-62, 1986.
      ...
      [BMM94] Brian\c{c}on, Maisonobe, Merle, Localisation de syst\`{e}mes diff\'{e}rentiels,
      stratifications de Whitney et condition de Thom, Invent. Math. 117(1):531-550, 1994.

      [BMS06] Budur, Musta\c{t}\u{a}, Saito, Bernstein-Sato polynomials of arbitrary varieties,
      Compositio Math. 142(3):779-797, 2006.

      [CJT01] Castro-Jim\'{e}nez, Takayama, The computation of the logarithmic cohomology
      for plane curves, J. Algebra 11, vol 322, 2009.

      [CL12] Castro-Jim\'{e}nez, Leykin, Computing localizations iteratively, in
      Harmony of Gr\"{o}bner Bases and the Modern Industrial Society, World Scientific,
      26-40, 2012.
      ...
      [Wal00] Walther, The cup product structure for complements of complex affine
      varieties, J. Pure Appl. Algebra, 2000.
///
