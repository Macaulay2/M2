...
function initializeBuilder() {
  ...
  if (fixExtremalNodes) {
    document.getElementById("extremalNodeToggle").text =
      "Don't fix extremal nodes";
  }
...
function resetPoset() {
  ...
  nodes.forEach(function (d) {
    groupFreq[d.group] = groupFreq[d.group] + 1;
  });

  for (var i = 0; i < nodes.length; i++) {
    groupCount[nodes[i].group] = groupCount[nodes[i].group] + 1;
    nodes[i].x =
      groupCount[nodes[i].group] *
      ((width - 2 * hPadding) / (groupFreq[nodes[i].group] + 1));
    nodes[i].px =
      groupCount[nodes[i].group] *
      ((width - 2 * hPadding) / (groupFreq[nodes[i].group] + 1));
  }
  ...
  g.append("svg:circle")
    ...
    .on("mouseup", function (d) {
      ...
      if (dataRelMatrix[sourceID][targetID] != 1) {
        ...
        var tempMatrix = completeTransitiveClosure(
          dataRelMatrix,
          sourceID,
          targetID,
        );
        if (!tempMatrix) {
          ...
          link = links.filter(function (l) {
            return (
              l.source.id == d3.min([sourceID, targetID]) &&
              l.target.id == d3.max([sourceID, targetID])
            );
          })[0];
...
function highlightAllComparable(n) {
  ...
  for (var i = 0; i < rel.length; i++) {
    ...
    if (rel[i][1] == n.id) {
      compElt.push(rel[i][0]);
    }
    if (rel[i][0] == n.id) {
      compElt.push(rel[i][1]);
    }
  }
  ...
  for (var i = 0; i < links.length; i++) {
    links[i].highlighted =
      containedIn(links[i].source.id, compElt) &&
      containedIn(links[i].target.id, compElt);
  }
...
function nodesFromLabelsGroups(labelList, groupList) {
  ...
  for (var i = 0; i < temp.length; i++) {
    ...
    temp[i].x =
      groupCount[temp[i].group] *
      ((width - 2 * hPadding) / (groupFreq[temp[i].group] + 1));
    temp[i].px =
      groupCount[temp[i].group] *
      ((width - 2 * hPadding) / (groupFreq[temp[i].group] + 1));
  }
...
function linksFromNodesRelations(nodeList, relList) {
  ...
  for (var i = 0; i < relList.length; i++) {
    ...
    temp.push({
      source: nodeList[minNode],
      target: nodeList[maxNode],
      left: false,
      right: false,
      highlighted: false,
    });
...
function posetRankFunction(relMatrix) {
  ...
  for (var i = 0; i < covRel.length; i++) {
    //
    var tmp =
      rk[covRel[i][1]][rk[covRel[i][1]].length - 1] -
      rk[covRel[i][0]][rk[covRel[i][1]].length - 1] -
      1;
...
function onclickResults(m2Response) {
  if (clickTest == "isAtomic") {
    d3.select("#isAtomic").html(
      "&nbsp;&nbsp; isAtomic :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isBounded") {
    d3.select("#isBounded").html(
      "&nbsp;&nbsp; isBounded :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isDistributive") {
    d3.select("#isDistributive").html(
      "&nbsp;&nbsp; isDistributive :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isGeometric") {
    d3.select("#isGeometric").html(
      "&nbsp;&nbsp; isGeometric :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isGraded") {
    d3.select("#isGraded").html(
      "&nbsp;&nbsp; isGraded :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isLattice") {
    d3.select("#isLattice").html(
      "&nbsp;&nbsp; isLattice :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isLowerSemilattice") {
    d3.select("#isLowerSemilattice").html(
      "&nbsp;&nbsp; isLowerSemilattice :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isLowerSemimodular") {
    d3.select("#isLowerSemimodular").html(
      "&nbsp;&nbsp; isLowerSemimodular :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isModular") {
    d3.select("#isModular").html(
      "&nbsp;&nbsp; isModular :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isRanked") {
    d3.select("#isRanked").html(
      "&nbsp;&nbsp; isRanked :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isSperner") {
    d3.select("#isSperner").html(
      "&nbsp;&nbsp; isSperner :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isStrictSperner") {
    d3.select("#isStrictSperner").html(
      "&nbsp;&nbsp; isStrictSperner :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isUpperSemilattice") {
    d3.select("#isUpperSemilattice").html(
      "&nbsp;&nbsp; isUpperSemilattice :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "isUpperSemimodular") {
    d3.select("#isUpperSemimodular").html(
      "&nbsp;&nbsp; isUpperSemimodular :: <b>" + m2Response + "</b>",
    );
  } else if (clickTest == "dilworthNumber") {
    d3.select("#dilworthNumber").html(
      "&nbsp;&nbsp; dilworthNumber :: <b>" + m2Response + "</b>",
    );
  }
}
...
$(document).ready(function () {
  ...
  $("#isAtomic").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isAtomic/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isBounded").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isBounded/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isDistributive").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isDistributive/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isGeometric").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isGeometric/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isGraded").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isGraded/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isLattice").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isLattice/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isLowerSemilattice").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isLowerSemilattice/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isLowerSemimodular").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isLowerSemimodular/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isModular").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isModular/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isRanked").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isRanked/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isSperner").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isSperner/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isStrictSperner").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isStrictSperner/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isUpperSemilattice").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isUpperSemilattice/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#isUpperSemimodular").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/isUpperSemimodular/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
  ...
  $("#dilworthNumber").on("click", function () {
    ...
    makeCorsRequest(
      "POST",
      "http://localhost:" + portData + "/dilworthNumber/",
      poset2M2Constructor(dataLabels),
      onclickResults,
    );
  });
