...
elapsedTime nops#0 = noetherianOperators(I, primes#0, Strategy => "MacaulayMatrix")
elapsedTime nops#1 = noetherianOperators(I, primes#1, Strategy => "MacaulayMatrix")
elapsedTime nops#2 = noetherianOperators(I, primes#2)
elapsedTime nops#3 = noetherianOperators(I, primes#3)
-- This takes very long
elapsedTime nops#4 = noetherianOperators(I, primes#4, Strategy => "MacaulayMatrix")
-- The hybrid method performs much faster
elapsedTime nops#4 = noetherianOperators(I, primes#4, Strategy => "Hybrid")
