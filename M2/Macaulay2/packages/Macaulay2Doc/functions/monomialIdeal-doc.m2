...
document { 
     ...
     the result is generated by only the lead monomials given: no Groebner bases are computed.
     See ", TO (monomialIdeal,Ideal), " if the lead monomials of a Groebner basis is desired.",
     EXAMPLE lines ///
	  R = ZZ/101[a,b,c];
...
document { 
     ...
     Headline => "monomial ideal of lead monomials of a Groebner basis",
     Usage => "monomialIdeal J",
     Inputs => {
	  "J"
	  },
     Outputs => {
	  MonomialIdeal => {"the monomial ideal generated by the lead monomials of a Groebner basis of ", 
	       TT "J" } },
