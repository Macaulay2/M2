...
-- To understand what Macaulay 2 is doing here, let's break
...
betti C
-- Use {\tt help (betti,ChainComplex)} for a detailed description
...
-- subquotient module.  As Macaulay 2 often returns such objects, it
...
A = QQ[a,b,c]
A ** A
-- Oops!  Macaulay 2 doesn't know what a should be!
B = oo
a == B_3
a == B_0
