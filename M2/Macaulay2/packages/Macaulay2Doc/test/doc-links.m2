needsPackage "Text"
-- we are going to fix the documentation maker so it gets headlines from the raw documentation database, not from loading the package
assert ( match ( 
	  "<a href=\"file:///.*FirstPackage/html/index\\.html\" title=\"an example Macaulay2 package\">FirstPackage</a>",
	  html TO "FirstPackage"))
assert ( match (
