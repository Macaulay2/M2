     ...
     UL {
	  LI { "new packages:",
	       UL {
            ...
            LI { TO "QuatenaryQuartics", ", a package by Kapustka, Kapustka, Ranestad, Schenck, Stillman and Yuan containing code and examples for their paper arxiv:2111.05817, has been added." }
		    }
	       },
