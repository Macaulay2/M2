...
doc ///
  ...
  Description
    Text
      @UL {
	  {BOLD "IntRing", TEX " -- the simplest algorithm available.
...
doc ///
  ...
  Inputs
    I:Ideal
      a holonomic ideal in the Weyl algebra $A_n(K)$
    w:List
...
doc ///
  ...
  Inputs
    M:Module
      a holonomic module over a Weyl algebra $A_n(K)$
    w:List
      a list of integer weights corresponding to the differential variables in the Weyl algebra
    m:List
...
doc ///
  ...
  Description
    Text
      @BOLD "Definition."@ Let $D = A_{2n}(K) = K\langle x_1,\ldots,x_n,d_1,\ldots,d_n\rangle$
      be a Weyl algebra.
      The Bernstein-Sato polynomial of a polynomial $f$ is defined
      to be the monic generator of the ideal of all polynomials
      ...
      @BOLD "Algorithm."@
      Let $I_f = D\langle t,dt\rangle \cdot \langle t-f, d_1+\partial f/\partial x_1 \cdot dt, \ldots, d_n+\partial f/\partial x_n \cdot dt\rangle$.
...
doc ///
  ...
  Outputs
    b:RingElement
      the general Bernstein-Sato polynomial $b(s)$ in $\QQ[s]$
  Description
    Text
      Bernstein-Sato polynomial for an arbitrary affine variety was introduced in
      Budur, Mustata, and Saito, ``Bernstein--Sato polynomials of arbitrary varieties''.
...
doc ///
  Key
    ViaLinearAlgebra
  Headline
    an option for generalB=>Strategy
  Description
    Text
      See @TO "generalB"@.
///
...
doc ///
  ...
  Outputs
    :List
      the list of the integer roots of @TT "b"@
  SeeAlso
    globalBFunction
    bFunction
///
...
doc ///
  ...
  Inputs
    f:RingElement
      a polynomial in Weyl algebra $A_n(\QQ)$
    file:File
