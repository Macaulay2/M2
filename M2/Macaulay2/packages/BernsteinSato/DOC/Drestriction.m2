...
doc ///
  ...
  Inputs
    ...
    I:Ideal
      which represents the module $M = D/I$
    w:List
      a weight vector determining restriction coordinates
    i:ZZ
      nonnegative cohomological degree
  Outputs
    Ni:Module
      the $i$-th derived restriction module of $M$ with respect to the weight vector $w$
    N:HashTable
      contains entries of the form @TT "i=>Ni"@
    NIi:Module
      the $i$-th derived restriction module of $D/I$ with respect to the weight vector $w$
    NI:HashTable
  ...
  Description
    ...
    Example
      ...
      Drestriction(I,{1,0})
  Caveat
    The module $M$ should be specializable to the subspace.
    This is true for holonomic modules.
    The weight vector $w$ should be a list of $n$
    numbers if $M$ is a module over the $n$-th Weyl algebra.
  SeeAlso
    DrestrictionAll
    DrestrictionClasses
    DrestrictionComplex
...
doc ///
  ...
  Outputs
    :Ideal
      the restriction ideal of $M$ w.r.t. the weight vector $w$
  Description
    Text
      A supplementary function for @TO "Drestriction"@
      that computes the restriction ideal.
  ...
  Caveat
    ...
    This is true for holonomic modules.
    The weight vector $w$ should be a list of $n$ numbers if $M$
    is a module over the $n$-th Weyl algebra.
  SeeAlso
    Drestriction
    DrestrictionAll
    Dintegration
...
doc ///
  Key
    HomologyModules
  Headline
    a key in a hashtable; an option of DExt
  SeeAlso
    Drestriction
    Dintegration
    DExt
...
doc ///
  Key
    GenCycles
  Headline
    a key in the hashtable created by Drestriction/Dintegration
  SeeAlso
    Drestriction
    Dintegration
///
...
doc ///
  Key
    IntegrateComplex
  Headline
    a key in the hashtable created by Dintegration
  SeeAlso
    Dintegration
///
...
doc ///
  Key
    Dintegration
    (Dintegration, ZZ, Module, List)
    (Dintegration, Ideal, List)
  ...
  Inputs
    ...
    I:Ideal
      which represents the module $M = D/I$
    w:List
      a weight vector determining the projection coordinates
    i:ZZ
      nonnegative cohomological degree
  Outputs
    Ni:Module
      the $i$-th derived integration module of $M$ with respect to the weight vector $w$
    N:HashTable
      contains entries of the form @TT "i=>Ni"@
    NIi:Module
      the $i$-th derived integration module of $D/I$ with respect to the weight vector $w$
    NI:HashTable
      contains entries of the form @TT "i=>NIi"@
  Description
    Text
...
doc ///
  ...
  Outputs
    :Ideal
      the integration ideal of $M$ w.r.t. the weight vector $w$
  Description
    Text
      A supplementary function for @TO "Dintegration"@
      that computes the integration ideal.
