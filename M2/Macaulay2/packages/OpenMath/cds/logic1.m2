...
OMSEvaluators#"logic1"#"and" = args -> ( a := apply(args, fromOpenMath); (a#0) and (a#1) )
OMSEvaluators#"logic1"#"or" = args -> ( a := apply(args, fromOpenMath); (a#0) or (a#1) )
OMSEvaluators#"logic1"#"not" = args -> ( a := apply(args, fromOpenMath); not(a#0))
