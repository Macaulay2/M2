...
Node
  ...
  Description
    Text
      ...
      the $x$'s commute with each other; the $dx$'s commute with each other; $x_i$ commutes with $dx_j$ if $i\neq j$;
      and finally, $dx_i x_i = x_i dx_i + 1$ (the Leibniz rule).
    ...
    Text
      A-Hypergeometric systems, also known as GKZ systems (see [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Chapters 3 and 4]) are implemented.
    ...
    Text
      Holonomic $D$-ideals are analogous to zero-dimensional ideals in polynomial rings (see [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Section 1.4]).
    ...
    Text
      We can compute the characteristic ideal and singular locus of a $D$-ideal [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Section 1.4]. Note that the output of charIdeal
    ...
    Text
      ...
      (see [@TO2 ("WeylAlgebras :: Works Cited", "GKZ94")@, Chapters 8 and 9]).
      Here is how to find the classic cubic discriminant.
