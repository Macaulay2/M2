...
EXAMPLE {"X = cubicFourfold \"quintic del Pezzo surface\";", "time discriminant X"},
SeeAlso => {(discriminant, GushelMukaiFourfold)}}
...
EXAMPLE {"X = gushelMukaiFourfold \"tau-quadric\";", "time discriminant X"},
SeeAlso => {(discriminant, CubicFourfold)}}

undocumented{(expression, GushelMukaiFourfold), (describe, GushelMukaiFourfold)}

document {Key => {Verbose, [cubicFourfold, Verbose], [gushelMukaiFourfold, Verbose], [mirrorFourfold, Verbose], [specialFourfold, Verbose], [parameterCount, Verbose],  [associatedK3surface, Verbose], [associatedCastelnuovoSurface, Verbose], [detectCongruence, Verbose], [trisecantFlop, Verbose]},
...
EXAMPLE {"X = cubicFourfold \"quartic scroll\";", "describe X", "time U' = associatedK3surface X;", "(mu,U,C,f) = building U';", "? mu", "? U", "last C", "assert(image f == U')"},
SeeAlso => {(associatedK3surface, GushelMukaiFourfold), detectCongruence, mirrorFourfold}}
...
EXAMPLE {"X = gushelMukaiFourfold \"tau-quadric\";", "describe X", "time U' = associatedK3surface X;", "(mu,U,C,f) = building U';", "? mu", "? U", "first C -- two disjoint lines", "assert(image f == U')"},
SeeAlso => {(associatedK3surface, CubicFourfold), detectCongruence, mirrorFourfold}}
...
document {Key => {DoublySpecialCubicFourfold, (symbol &, EmbeddedProjectiveVariety, EmbeddedProjectiveVariety), surfaces, (surfaces, DoublySpecialCubicFourfold)},
...
SeeAlso => {CubicFourfold, (polarizedK3surface, DoublySpecialCubicFourfold)}}

document {Key => {polarizedK3surface, (polarizedK3surface, DoublySpecialCubicFourfold), FanoMapType, [polarizedK3surface, FanoMapType], [polarizedK3surface, Strategy], [polarizedK3surface, Verbose], latticePolarization},
...
UL {{TT "building E", " -- returns the four construction objects as in ", TO (associatedK3surface, CubicFourfold), " (the Fano rational map ", TEX///$\mu$///, ", the non-minimal K3 surface ", TEX///$U$///, ", the exceptional curves on ", TEX///$U$///, " and the morphism ", TEX///$f: U \to E$///, " contracting them);"}, {TT "projectiveVariety E", " -- returns the underlying ", TO2{EmbeddedProjectiveVariety, "projective surface"}, ";"}, {TT "latticePolarization E", " -- returns the lattice data induced by the double special structure of ", TEX///$X$///, "."}},
