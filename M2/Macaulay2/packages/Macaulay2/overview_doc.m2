...
document { Key => {SYNOPSIS,Heading,[SYNOPSIS, Caveat],[SYNOPSIS, Consequences],[SYNOPSIS, Inputs],[SYNOPSIS, Outputs],[SYNOPSIS, SeeAlso],[SYNOPSIS, Usage],[SYNOPSIS, Function]},
     PARA {
