...
document { 
     Key => (value,SparseVectorExpression),
     Headline => "",
     Usage => "",
     Inputs => {
	  },
...
document { 
     Key => (value,NonAssociativeProduct),
     Headline => "",
     Usage => "",
     Inputs => {
	  },
...
document { 
     Key => (value,SparseMonomialVectorExpression),
     Headline => "",
     Usage => "",
     Inputs => {
	  },
