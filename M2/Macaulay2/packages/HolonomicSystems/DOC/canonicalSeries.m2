doc ///
  ...
  Description
    ...
    Text
      ...
      $\theta_1 = x_1 dx_1, \dots, \theta_n = x_n dx_n$. This is a commutative polynomial subring of $D$,
    ...
    Text
      ...
      extend and contract; see [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@]
    Example
      R2 = QQ[x_1..x_3]
      W2 = makeWA R2
      gens W2
    ...
    Text
      ...
      This is worked out as [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, page 138, Example 3.5.3].
    Example
    ...
    Text
      ...
      [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, page 138] has the polynomial, and four terms of the logarithmic series.
  Subnodes
    "cssExpts"
    "cssExptsMult"
    "cssLeadTerm"
...
doc ///
   ...
   Description
    Text
      Given a monomial $x^u dx^v$, this function rewrites it as a product $x^a p(\theta) dx^b$,
      where $\theta_i = x_i dx_i$ for $i = 1,\dots, n$. This is a step in a procedure for checking
      that a $D$-ideal is torus-fixed, and is used in the @TO isTorusFixed@ routine.

      Given a torus-fixed $D$-ideal, this function computes the distraction as in [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Corollary 2.3.5].
      This is necessary to compute indicial ideals [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Theorem 2.3.9, Corollary 2.3.5];
...
doc ///
   ...
   Outputs
     :Ideal
       obtained by extending the ideal $in_{(-w,w)}(I)$ to the Weyl algebra
       with rational-function coefficients and contracting back to the thetaRing
       of $D$, as in [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Theorem 2.3.9].
   Description
    Text
      This computes the distraction of a torus-fixed $D$-ideal [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Corollary 2.3.5].
      This is necessary to compute indicial ideals [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Theorem 2.3.9, Corollary 2.3.5];
      the roots of the indicial ideals are the exponents of the starting terms of canonical series
      solutions of regular holonomic $D$-ideals.
    Example
...
doc ///
   ...
   Outputs
     :List
       of exponents of the canonical series solutions of $I$
...
doc ///
   ...
   Outputs
     :List
       of starting exponents of the canonical series solutions of $I$
       in the direction of $(-w,w)$, as in
       [@TO2 ("WeylAlgebras :: Works Cited", "SST00")@, Theorem 2.3.11],
...
doc ///
   ...
   Outputs
     :Boolean
       true if $I$ is torus-fixed, otherwise false
   Description
    Text
       There is a natural action of the $n$-dimensional algebraic torus on $D$
       where $t \in (\mathbb{C}^*)^n$ acts on $dx_i$ as $t_i dx_i$ and on
...
doc ///
   ...
   Inputs
     I:Ideal
       a Frobenius ideal which is $\mathfrak{m}$-primary
     W:Ring
       a Weyl algebra (defaults to one built from the ring of $I$)
   Outputs
     :List
