...
doc ///
   ...
   Description
    Text
      Let $R$ be the subalgebra of the polynomial ring $k[x_1,\ldots,x_n]$ generated by $f_1,\ldots ,f_k.$ We say 
      $f_1,\ldots,f_k$ form a {\it subalgebra basis} with respect to a monomial order $<$ if the {BOLD initial algebra},
      $in_< R := \{ in_< f \mid f \in R \},$ is generated by $\in_< f_1, \ldots , \in_< f_k.$ 
///
...
doc ///
   ...
   Inputs
     M:Matrix
       a one-row matrix whose entries are in a @TO "PolynomialRing"@
     Limit=>ZZ
   ...
   Outputs
     N:Matrix
       a one-row matrix whose elements form a partial subalgebra basis for the algebra generated by entries of M
   Description
    Text
...
R=QQ[x,y,MonomialOrder=>Lex]
M=matrix{{x+y,x*y,x*y^2}}
N=subalgebraBasis(M,Limit=>10,PrintLevel=>2)
