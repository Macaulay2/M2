...
complex HashTable := Complex => complexOptions >> opts -> maps -> tryHooks(
    (complex, HashTable), (opts, maps), (opts, maps) -> (
...
complex List := Complex => complexOptions >> opts -> tryHooks(
    (complex, List), (opts, L), (opts, L) -> (
