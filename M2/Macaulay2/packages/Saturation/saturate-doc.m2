...
Node
  ...
  Inputs
    ...
    J:{Ideal,MonomialIdeal,Module,RingElement,Number,List}
  ...
  Description
    Text
      ...
      If @TT "J"@ is a ring element or number, then the principal ideal generated by @TT "J"@ is used.
      If @TT "J"@ is a list, then saturation is applied successively with respect to each element of the list.
