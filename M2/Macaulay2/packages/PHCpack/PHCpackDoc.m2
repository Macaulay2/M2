...
doc ///
  ...
  Description
    ...
    Text
      ...
      Each solution is of type Point and contains diagnostic information 
    ...
    Text      
      ...
      The package offers methods to furhter refine the numerical solutions, for example, filter them to obtain only those whose
      coordinates are below or above a given tolerance, or refine them to a higher precision. Furhter detials and examples can
      be found in subsequent documentation nodes. 
  Caveat
...
doc ///
  ...
  Outputs
    :NumericalVariety
      ...
      contained in the zero locus of the ideal generated by L. 
  Consequences
    Item
      Invokes the command {\tt phc -c}. 
  Description
    Text
      ...
      each pure dimensional variety contained in V(I).  (invokes "phc -c") 
