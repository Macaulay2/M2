...
doc ///
  ...
  Description
    Text
      Interface to the software {\tt PHCpack} 
      to solve polynomial systems and perform calculations in
      {\em numerical algebraic geometry}.  {\tt PHCpack} is available at
...
doc ///
  Key 
    ...
    (cascade,List)
  Headline
    runs a cascade of homotopies to get witness sets for the solution set of a system of polynomials (invokes "phc -c")
  Usage
    C = cascade L
  Inputs
    L:List 
...
doc ///
  Key
    StartDimension
  Headline
    start dimension, optional input for cascade and numericalIrreducibleDecomposition
  Description
    Text
...
doc ///
  ...
  Usage
    isCoordinateZero = isCoordinateZero(sol,k,tol)
  Inputs
    sol:Point
...
doc ///
  ...
  Headline
    tests whether a point belongs to a solution set, invokes "phc -f"
  Usage
    B = isWitnessSetMember(W,p)
  Inputs
    W:WitnessSet
...
doc ///
  ...
  Headline
    find the irreducible components of the zero set of a system of polynomials
  Usage
    V = numericalIrreducibleDecomposition (system)
  Inputs
    system:List
  ...
  Description
    Text
      Given a list of generators of an ideal I, this function calls @TO cascade@ 
      and @TO factorWitnessSet@ and returns a @TO NumericalVariety@ with a 
...
doc ///
  ...
  Inputs
    ...
    sols:List
      solutions of the sytem of type @TO Point@ (from a previous calculation)
    dp:ZZ
...
doc ///
  ...
  Headline
    approximates solutions to a rational system of equations (invokes "phc -b")
  Usage
    sols = solveRationalSystem (f)
  Inputs
    f:List
...
doc ///
  ...
  Description
    Text
      ...
      for the given
      polynomial system with the given dimension and then calls @TO solveSystem@
