...
R = CC[x_1..x_4, MonomialOrder => {Weights=>4:-1}, Global => false]
...
P = {-1,1,1,-1}
P = {-1.0-.53734e-17*ii, 1.0-.20045e-16*ii, 1.0+.89149e-17*ii, -1.0+.18026e-17*ii}
P = {-1.0-.53734e-17, 1.0-.20045e-16, 1.0+.89149e-17, -1.0+.18026e-17}
dualInfo(M, Point=>P)
