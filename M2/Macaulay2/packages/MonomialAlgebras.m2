...
export {monomialAlgebraIdeal,
       decomposeMonomialAlgebra,decomposeHomogeneousMonomialAlgebra,
...
decomposeHomogeneousMonomialAlgebra=method(Options=>{Verbose=>0,ReturnMingens=>false,CoefficientField=>ZZ/101})
...
doc ///
  ...
  Description
    Text
      ...
      For the existence of the decomposition in the general (non-simplicial) case and for an algorithm 
      for computing the decomposition see:

      J.Boehm, D. Eisenbud, M. Nitsche: Decomposition of semigroup algebras, 2011, to appear in Experim. Math., @HREF"http://arxiv.org/abs/1110.3653"@.

      Using the decomposition algorithm, the package also provides fast functions to test ring-theoretic
      properties of monomial algebras, and to compute the regularity.
      ...
      Computation of the binomial ideal associated to B via the function @TO monomialAlgebraIdeal@
...
doc ///
  Key
    ...
    [decomposeHomogeneousMonomialAlgebra,ReturnMingens]
  Headline
