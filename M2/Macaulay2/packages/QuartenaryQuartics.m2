...
newPackage(
    ...
    Version => "0.99",
    Date => "11 Nov 2021",
    Headline => "code to support the paper 'Quartic Forms and Gorenstein Rings'",
    Authors => {
...
load "./QuartenaryQuartics/Section1Doc.m2"
load "./QuartenaryQuartics/Section2Doc.m2"
load "./QuartenaryQuartics/Section3Doc.m2"
load "./QuartenaryQuartics/Section4Doc.m2"
load "./QuartenaryQuartics/Section5Doc.m2"
load "./QuartenaryQuartics/Section6Doc.m2"
load "./QuartenaryQuartics/Section7Doc.m2"
load "./QuartenaryQuartics/Section8Doc.m2"
load "./QuartenaryQuartics/Section9Doc.m2"
load "./QuartenaryQuartics/Appendix2.m2"
...
doc ///
    ...
    Description
        Text
            ...
            {\it Quartenary Quartic Forms and Gorenstein Rings},
    ...
    References
        @TO "[QQ]"@ {\it Quartenary Quartic Forms and Gorenstein Rings},
            by Grzegorz Kapustka,
            Michal Kapustka, Kristian Ranestad, Hal Schenck, Mike
...
doc ///
    Key
        "[QQ]"
    Headline
        Quartenary Quartic Forms and Gorenstein rings (Kapustka, Kapustka, Ranestad, Schenck, Stillman, Yuan, 2021)
    Description
        Text
            [QQ] @arXiv("2111.05817", "Quartenary Quartic Forms and Gorenstein Rings")@
            by Grzegorz Kapustka,
            Michal Kapustka, Kristian Ranestad, Hal Schenck, Mike
...
-*
  restart
  needsPackage "QuartenaryQuartics"
*-
  S = ZZ/101[a..d]
  M = randomPoints(S, 7)
...
-* Development section *-
restart
debug needsPackage "QuartenaryQuartics"
check "QuartenaryQuartics"

restart
installPackage "GroebnerStrata"
uninstallPackage "QuartenaryQuartics"
restart
installPackage "QuartenaryQuartics"
viewHelp "QuartenaryQuartics"
check QuartenaryQuartics
