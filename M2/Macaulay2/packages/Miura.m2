...
export {"setPolynomialRing", "setQuotientRing", "inverse", "reduced", "add", "double", "scalarMultiplication"}
...
document{
    ...
    Usage => "K=inverse(J)",
    Outputs => {ofClass Ideal},
    Headline => "Compute Inverse Ideal",
    PARA {"The function inverse computes the inverseerse reduced ideal given an integral ideal"},    
	EXAMPLE {"setPolynomialRing(GF 7,{x,y},{2,3})", "setQuotientRing(y^2-x^3-3*x)", "J=ideal(x,y); inverse(J)"}
}
