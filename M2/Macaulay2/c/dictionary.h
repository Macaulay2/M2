...
extern node void_T, undefined_T, null_T, polymorphic_T, deferred_T;
...
extern node getmem_S, sizeof_S, function_K, define_S, define_recursive_types_K,
   ...
   len__S, setd_K, if_K, foreach_K, le_S, plusplus_S, object_S, clean_S,
   ...
   ushort_K, uint_K, ulong_K, uchar_K, polymorphic_K, oror_S, andand_S, pointer_K,
   str_S,
