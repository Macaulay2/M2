...
#include <string>
/***
	Set of export include headers needed to be included.
	This is generated by looking at signatures.
***/
extern std::set<std::string> headerFilesNeeded;
/***
	Set of prefixes for typedefs that occur from imports
	This is generated by looking at signatures.
***/
extern std::set<std::string> importPrefixes;
/*
# Local Variables:
