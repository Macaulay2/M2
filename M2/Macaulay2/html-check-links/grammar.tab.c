...
/* Line 189 of yacc.c  */
#line 5 "../../../../Macaulay2/html-check-links/grammar.y"
...
{
      12,     0,    -1,    -1,    11,    -1,    12,    13,    -1,    -1,
       3,    14,    15,     4,    -1,     1,     4,    -1,    11,    -1,
      15,    17,    -1,     9,    -1,     8,    -1,     7,    -1,     6,
      -1,     6,     5,     6,    -1,    16,     5,     6,    -1
};
...
{
  "$end", "error", "$undefined", "'<'", "'>'", "'='", "WORD", "SRC",
  "HREF", "BACKGROUND", "$accept", "empty", "html", "tag", "$@1", "values",
  "key", "value", 0
};
#endif
...
{
       0,   256,   257,    60,    62,    61,   258,   259,   260,   261
};
# endif
...
{
       0,    11,    12,     0,     1,     3,    13,     4,    14,    11,
      15,     4,     6,     7,     8,     9,    16,    17,     5,     5,
       6,     6
};
...
/* Line 1455 of yacc.c  */
#line 44 "../../../../Macaulay2/html-check-links/grammar.y"
    { opening("unmatched '<'"); }
    break;
...
/* Line 1455 of yacc.c  */
#line 45 "../../../../Macaulay2/html-check-links/grammar.y"
    { closing(); }
    break;
...
/* Line 1455 of yacc.c  */
#line 52 "../../../../Macaulay2/html-check-links/grammar.y"
    { checkURL((yyvsp[(3) - (3)])); }
    break;
...
/* Line 1675 of yacc.c  */
#line 55 "../../../../Macaulay2/html-check-links/grammar.y"
 /* programs */
