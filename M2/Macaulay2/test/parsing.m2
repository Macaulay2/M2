...
assert( parse(ratNumberP, "234/131") === 234/131 )
assert( parse(ratNumberP, "-234/131") === -234/131 )
assert( parse(optP constP "-", "") === nil )
assert( parse(andP(optP constP "-",optP constP "+"), "") === (nil,nil) )
assert( parse(andP(optP constP "-",optP constP "+"), "+") === (nil,"+") )
assert( parse(andP(optP constP "-",optP constP "+"), "-") === ("-",nil) )
assert( parse(andP(optP constP "-",optP constP "+"), "-+") === ("-","+") )
assert( (try parse(andP(optP constP "-",optP constP "+"), "+-") else oops) === oops )
assert( parse(integerP, "234") === 234 )
assert( parse(integerP, "-234") === -234 )
assert( parse(integerP, "+234") === 234 )
assert( parse(orP(natNumberP,constP "ab"), "234") === 234 )
assert( parse(orP(natNumberP,constP "ab"), "ab") === "ab" )
assert( (try parse(orP(natNumberP,constP "ab"), "a") else oops) === oops )
assert( (try parse(orP(natNumberP,constP "ab"), "abc") else oops) === oops )
assert( (try parse(andP(natNumberP,constP "ab"), "234a") else oops) === oops )
assert( (try parse(andP(natNumberP,constP "ab"), "234b") else oops) === oops )
assert( parse(andP(natNumberP,constP "ab"), "234ab") === (234,"ab") )
assert( (try parse(andP(natNumberP,constP "ab"), "234abc") else oops) === oops )
assert( parse(repP andP(constP ",", natNumberP), ",33,4") === ((",",33),(",",4)) )
