...
# Model the real Core configuration, which also registers these source inputs.
configure_file("'''+str(repo)+'''/M2/Macaulay2/m2/startup.m2.in" startup.m2 @ONLY)
configure_file("'''+str(repo)+'''/M2/Macaulay2/m2/version.m2.in" version.m2 @ONLY)
