...
if(GFAN)
  execute_process(COMMAND ${GFAN} _version OUTPUT_VARIABLE GFAN_VERSION_OUTPUT ERROR_QUIET)
  string(REGEX MATCH "gfan([0-9]+\\.[0-9]+[a-z]*)" _gfan_match "${GFAN_VERSION_OUTPUT}")
  set(GFAN_VERSION "${CMAKE_MATCH_1}")
  if(GFAN_VERSION VERSION_LESS "0.8")
    message(STATUS "Found gfan version ${GFAN_VERSION}, but >= 0.8 is required; will build from source")
    unset(GFAN CACHE)
  endif()
endif()
