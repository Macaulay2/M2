...
if(REPRODUCIBLE_CACHED_FILE_PATHS)
  set(STARTUP_M2_ADDR "/path/to/source/M2/Macaulay2/m2/startup.m2.in")
endif()
...
foreach(BASICTEST_FILE ${BASICTEST_FILES})
  ...
  if(REPRODUCIBLE_CACHED_FILE_PATHS)
    get_filename_component(BASICTEST_M2_BASENAME ${BASICTEST_M2_ADDR} NAME)
    set(BASICTEST_M2_ADDR
      "/path/to/source/M2/Macaulay2/m2/basictests/${BASICTEST_M2_BASENAME}")
  endif()
