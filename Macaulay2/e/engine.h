...
extern "C" {
  ...
  */
  ...
  const Matrix *IM2_Matrix_promote(const FreeModule *newTarget, const Matrix *f); /* connected to rawPromote*/

  const Matrix *IM2_Matrix_lift(const FreeModule *newTarget, const Matrix *f); /* connected to rawLift */
