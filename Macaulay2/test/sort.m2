x  = {symbol generators, symbol size, symbol symmetricPower, symbol " ", symbol "!", symbol "#", symbol "%", symbol "&", symbol tex, symbol "*", symbol "+", symbol "-", symbol ".", symbol
      ...
      symbol ann, symbol leadTerm, symbol OrderedMonoid, symbol any, symbol genus, symbol isSquareFree, Lex, symbol modifyRing, symbol applyPairs, symbol unlink, symbol exp, symbol QQ,
