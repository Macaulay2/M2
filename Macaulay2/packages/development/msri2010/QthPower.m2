...
newPackage(
    ...
    Authors => {{Name => "Douglas Leonard", Email => "leonada@auburn.edu", HomePage => "http://dms.auburn.edu/~leonada"},
                {Name => "David W. Cook II", Email => "dcook@ms.uky.edu", HomePage => "http://ms.uky.edu/~dcook"}},
