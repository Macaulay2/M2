...
Isep = saturate(I,first getSeparator(I,baseVars))
--- something up?
-- do we need to saturate first?
getMinimalPolynomial2(Isep,baseVars,a,a)
getMinimalPolynomial2(I,baseVars,e,e)
getMinimalPolynomial2(I,baseVars,j,j)
...
f = getMinimalPolynomial2(Isat,{c},d,d)
fList = apply(apply(apply(toList factor f,toList),i -> i_0^(i#1)), g -> f // g)
fList2 = apply(apply(toList factor f,toList),i -> i_0^(i#1))
netList fList
satList1 = apply(fList, g -> (I:g))
genList1 = apply(fList, g -> I + ideal g)
satList2 = apply(fList2, g -> (I:g))
genList2 = apply(fList2, g -> I + ideal g)
-- Ask mike about when I = (I:f/f_1) \cap \cdots \cap (I:f/f_n) where f = f_1\cdots f_n
trim intersect satList1 == I
trim intersect genList1 == I
trim intersect satList2 == I
trim intersect genList2 == I
isSubset(I,trim intersect satList)
presentation prune ((intersect satList) / I)

trim intersect satList == Isat
isSubset(Isat,trim intersect satList)
presentation prune ((intersect satList) / I)
