...
document {
     ...
     stop after a certain number of Gröbner basis elements have been discovered.",
...
document {
     ...
     by the leading terms of the Gröbner basis elements found so far reaches 
     a certain limit.",
     PARA{},
...
document {
     ...
     specifies that the columns of h are the syzygies for the Gröbner basis."
     }
