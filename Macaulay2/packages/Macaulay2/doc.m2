...
document {
     ...
     EXAMPLE "L#2",
     PARA,
     "For an overview of using lists, see ", TO "lists", ".",
     PARA,
     ...
     Subnodes => {
	  "An overview of using lists of integers:",
	  TO "lists of integers",
     	  "Length and ways to extract elements from lists:",
	  TO (symbol #, List),
	  TO (symbol #, List, ZZ),
	  TO (symbol #?, List, ZZ),
	  TO (symbol _, List, ZZ),
	  ...
	  TO first,
	  TO last,
	  "Converting sequences, arrays, sets, hash tables, mutable lists, etc. to lists:",
	  TO toList,
