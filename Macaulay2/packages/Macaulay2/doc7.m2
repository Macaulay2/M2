...
document {
     ...
     "If I is a ring element of R or ZZ, or a list or sequence of such elements, then I is understood to be the 
     ideal generated by these elements.  If I is a module, then it must be a submodule 
