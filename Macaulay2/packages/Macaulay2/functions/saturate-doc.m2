...
document { 
     ...
     Usage => "saturate(I,J)\nsaturate I",
     Inputs => {
	  "I" => {ofClass Ideal, ", ", ofClass Module, ", or ", 
	       ofClass MonomialIdeal},
	  "J" => {ofClass Ideal, ", or ", ofClass RingElement, ".
	       If not present, then ", TT "J", " is the ideal generated by the variables of the ring"}
	  },
     Outputs => {
	  {
	       ofClass Ideal, ", ", ofClass Module, ", or ", 
	       ofClass MonomialIdeal, ", the saturation of ", TT "I", " with respect to ", TT "J"}
	  },
     PARA{},
