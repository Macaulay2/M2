...
document {
     ...
     HEADER3 "functions",
     UL {
          LI (TO " ", " -- function application"),
	  TOH symbol->,
	  TOH symbol=>,
          LI (TO "@@", " -- composing functions"),
          LI (TO "\\", " -- applying a function to elements of a list"),
          LI (TO ">>", " -- bit shifting and attaching optional inputs to functions"),
	  },
     HEADER3 "subscripting and object access",
     UL {
          LI (TO "_", " -- subscripting"),
          LI (TO ".", " -- hash table access or assignment"),
          LI (TO ".?", " -- test for hash table access"),
          LI (TO "#", " -- hash table access; length of a list, sequence or hash table"),
          LI (TO "#?", " -- test for hash table access"),
	  },
     ...
     UL {
	  ...
	  TOH symbol-,
	  TOH symbol*,
	  LI (TO "/", " -- division, or applying a function to elements of a list"),
	  TOH symbol//,
	  TOH symbol%,
          LI (TO "\\\\", " -- left quotient"),
	  TOH symbol^,
	  ...
	  TOH symbol**,
          LI (TO "^**", " -- tensor power"),
          LI (TO "~", " -- making a coherent sheaf"),
	  TOH symbol(*),
          LI (TO ":", " -- ideal quotient, repetitions"),
     	  },
     HEADER3 "miscellaneous",
     UL {
          LI (TO "..", " -- sequence builder"),
          LI (TO "<<", " -- file output, bit shifting"),
          LI (TO ">>", " -- bit shifting and attaching optional inputs to functions"),
          LI (TO "|", " -- horizontal concatenation of strings or matrices"),
          LI (TO "||", " -- vertical concatenation of strings or matrices"),
          LI (TO "@"),
          LI (TO "^^"),
          LI (TO "|-"),
          LI (TO "<==>"),
     ...
     UL {
	  ...
	  TOH symbol.?,
	  TOH symbol#?,
          LI (TO ",", " -- separates elements of lists or sequences"),
          LI (TO ";", " -- statement separator"),
          LI (TO "in"),
	  },
