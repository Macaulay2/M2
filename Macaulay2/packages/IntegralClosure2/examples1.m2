...
--boehm1
S =QQ[u,v,z]
F = v^4-2*u^3*z+3*u^2*z^2-2*v^2*z^2
S/F
--------------------------------------------------
--boehm2
S =QQ[u,v,z]
...
S/F
--------------------------------------------------
-- boehm14 -- error: a non unit was found in a ring declared to be a field
S =QQ[u,v,z]
